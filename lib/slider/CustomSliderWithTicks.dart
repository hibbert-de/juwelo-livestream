    ...
    class SeekBarWithChapters extends StatefulWidget {
      const SeekBarWithChapters({super.key});

      @override
      _SeekBarWithChaptersState createState() =>
          _SeekBarWithChaptersState();
    }

    class _SeekBarWithChaptersState
        extends State<SeekBarWithChapters> {
